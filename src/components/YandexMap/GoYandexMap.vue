<template>
	<yandex-map :settings="settings" width="100%" height="500px" cursor-grab>
		...
		<yandex-map-clusterer zoom-on-cluster-click>
			...
			>
				<div class="marker">
					<div v-if="openMarker === index" class="popup" @click.stop="openMarker = null">{{ marker.title }}</div>
				</div>
			</yandex-map-marker>
